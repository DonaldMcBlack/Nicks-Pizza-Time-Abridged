...
PTV3_SKINS.pizzaface = setmetatable({
	[0] = {
...
}, PTV3_SKINS.pizzaface[0])
PTV3_SKINS.pizzaface[0].__index = PTV3_SKINS.pizzaface[0]

PTV3_SKINS.snick = setmetatable({
	[0] = {
...
PTV3_SKINS.snick[0].__index = PTV3_SKINS.snick[0]

PTV3_SKINS.johnGhost = setmetatable({
	[0] = {
...
}, PTV3_SKINS.johnGhost[0])
PTV3_SKINS.johnGhost[0].__index = PTV3_SKINS.johnGhost[0]

registerMetatable(PTV3_SKINS.pizzaface[0])
registerMetatable(PTV3_SKINS.snick[0])
registerMetatable(PTV3_SKINS.johnGhost[0])

-- for donald: you simply just do player.pizzaMobj_skindata = setmetatable({}, PTV3_SKINS.pizzaface)
