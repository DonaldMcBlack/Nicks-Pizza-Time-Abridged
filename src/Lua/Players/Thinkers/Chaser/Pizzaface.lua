...
local pizzaface = function(p)
	...
	and not (p.ptv3.pizzaface_chasedowncool)
	...
	if canMove
	and p.cmd.buttons & BT_CUSTOM2
	and not (p.ptv3.buttons & BT_CUSTOM2)
	and not (p.ptv3.pizzaface_teleportingcool)
	and not p.ptv3.pizzaface_teleporting
	and not (p.ptv3.pizzaface_chasedown) then
